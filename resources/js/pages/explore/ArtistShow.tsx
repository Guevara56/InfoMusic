...
const PLATFORM_CONFIG: Record<string, {
    ...
    'apple music': { icon: <FaApple size={16} />, color: '#fc3c44', bg: 'rgba(252,60,68,0.12)', label: 'Apple Music' },
    apple_music: { icon: <FaApple size={16} />, color: '#fc3c44', bg: 'rgba(252,60,68,0.12)', label: 'Apple Music' },
    apple: { icon: <FaApple size={16} />, color: '#fc3c44', bg: 'rgba(252,60,68,0.12)', label: 'Apple Music' },
